(defproject Monitor "1.0.0-SNAPSHOT"
  ...
  :manifest {"Class-Path" "."}
  :test-path "src"
  :jvm-opts [ "-Dstayalive=true" "-mx1G" "-Dcom.sun.management.jmxremote.port=3333" "-Dcom.sun.management.jmxremote.ssl=false" "-Dcom.sun.management.jmxremote.authenticate=false"]
